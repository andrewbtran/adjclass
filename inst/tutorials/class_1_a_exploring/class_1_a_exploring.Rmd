...
Do this and the result `%>% goes into this and something happens to it `%>%` and then somethin else.
...
**I am going to use pipes interchangeably in this walkthrough now.**
