...
total_reviews <- amazon %>% 
  html_nodes("#____________ .________") %>% 
  html_text()
...
If you enable ["Inspect Element"](https://sbgi.net/tv-stations/) in your browser, ou can see all the pieces that a website needs to run when you reload it.
