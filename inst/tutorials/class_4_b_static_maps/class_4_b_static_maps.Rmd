...
The choropleths we've made so far have been univarate maps, as in it visualizes one column of data.
...
[Cowplot](https://wilkelab.org/cowplot/articles/plot_grid.html) lets you combine different chart types into one and [biscale](https://chris-prener.github.io/biscale/) is the bivariate calulating package.
...
This will create 3 quantiles based on the estiamte and total.
...
Or what if you want to save it as a shapefile for editing in QGIS or D3?
