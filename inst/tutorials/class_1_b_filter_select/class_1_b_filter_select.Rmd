...
<iframe width="560" height="315" src="https://www.youtube.com/embed/uOwKS3IE8hk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
```
learnr::run_tutorial("class_1_c_mutate_summarize", "adjclass")
```
